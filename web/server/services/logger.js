...
module.exports = function (options) {
    ...
    const print = (function () {
        ...
        return function printFunc (ctx, ...args) {
            ...
            if (transporter) { transporter(ctx, string, args); } else { console.log(...args); }
        };
    })();
    ...
    // request
        ...
        let counter;
        if (length === null && body && body.readable) { ctx.body = body.pipe((counter = counterFunc())).on('error', ctx.onerror); }
